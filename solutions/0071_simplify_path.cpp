...
//   Explanation: '..' refers to the directory up a level (the parent directory).
//
// Example 4:
//   Input: path = "/../"
//   Output: "/"
...
public:
    string simplifyPath(string path) {
        auto parts = ranges::to<vector<string>>(views::split(path, '/'));
        auto canonical = std::vector<string>{};
